   ...
   FROM ( WITH cte_1 AS (
                 SELECT t.data_date,
                   ...
                   FROM ( SELECT  data_date,
                     ...
                     left JOIN ( SELECT  data_date,
                          ...
                          GROUP BY data_date, ins_auto_master_table_2022.age, ins_auto_master_table_2022.national_presence, ins_auto_master_table_2022.national_provider, '100/300/100,000 - 1500 comp_coll'::text) t2 
                          On t2.data_date = t.data_date and t.age::text = t2.age::text AND t.national_provider::text = t2.national_provider::text AND t.coverage = t2.coverage AND t.national_presence = t2.national_presence
                UNION
                 SELECT t.data_date,
                    t.age,
                    t.national_provider,
                   ...
                   FROM ( SELECT  data_date,
                     ...
                     LEFT JOIN ( SELECT  data_date,
                           ...
                           FROM {{ ref('ins_auto_pop_wt_new_premiums_full_inserted') }} ins_auto_master_table_2022
                          WHERE  (ins_auto_master_table_2022.age::text = ANY (ARRAY['25'::character varying::text, '40'::character varying::text, '65'::character varying::text])) AND ins_auto_master_table_2022.vehicles::text = '2012 Toyota Camry LE'::text AND (ins_auto_master_table_2022.insurancescore_alignment::text = ANY (ARRAY['Blank'::character varying::text, 'Good'::character varying::text])) AND ins_auto_master_table_2022.driving_record_violations::text = 'Clean'::text and is_user_a_veteran ='No'   AND ins_auto_master_table_2022.bi_pd_limit = '100/300/100000'::text
                          GROUP BY data_date, ins_auto_master_table_2022.age, ins_auto_master_table_2022.national_presence, ins_auto_master_table_2022.national_provider, '100/300/100,000 - 1000 comp_coll'::text) t2 
                          ON t.data_date = t2.data_date AND t.age::text = t2.age::text AND t.national_provider::text = t2.national_provider::text AND t.coverage = t2.coverage AND t.national_presence = t2.national_presence
                UNION
                 SELECT t.data_date,
                    t.age,
                    t.national_provider,
                   ...
                   FROM ( SELECT  data_date,
                     ...
                     LEFT JOIN ( SELECT  data_date,
                           ...
                           FROM {{ ref('ins_auto_pop_wt_new_premiums_full_inserted') }} ins_auto_master_table_2022
                          WHERE  (ins_auto_master_table_2022.age::text = ANY (ARRAY['25'::character varying::text, '40'::character varying::text, '65'::character varying::text])) AND ins_auto_master_table_2022.vehicles::text = '2012 Toyota Camry LE'::text AND (ins_auto_master_table_2022.insurancescore_alignment::text = ANY (ARRAY['Blank'::character varying::text, 'Good'::character varying::text])) AND ins_auto_master_table_2022.driving_record_violations::text = 'Clean'::text and is_user_a_veteran ='No'   AND ins_auto_master_table_2022.bi_pd_limit = '100/300/100000'::text
                          GROUP BY data_date, ins_auto_master_table_2022.age, ins_auto_master_table_2022.national_presence, ins_auto_master_table_2022.national_provider, '100/300/100,000 - 500 comp_coll'::text) t2 
                          ON t.data_date = t2.data_date AND t.age::text = t2.age::text AND t.national_provider::text = t2.national_provider::text AND t.coverage = t2.coverage AND t.national_presence = t2.national_presence
                UNION
                 SELECT t.data_date,
                    t.age,
                   ...
                   FROM ( SELECT  data_date,
                     ...
                     LEFT JOIN ( SELECT  data_date,
                          ...
                          GROUP BY data_date, ins_auto_master_table_2022.age, ins_auto_master_table_2022.national_presence, ins_auto_master_table_2022.national_provider, 'State Min - 500 comp_coll'::text) t2 
                          ON t.data_date = t2.data_date AND t.age::text = t2.age::text AND t.national_provider::text = t2.national_provider::text AND t.coverage = t2.coverage AND t.national_presence = t2.national_presence
                UNION
                 SELECT t.data_date,
                    t.age,
                   ...
                   FROM ( SELECT  data_date,
                     ...
                     LEFT JOIN ( SELECT  data_date,
                           ...
                           FROM {{ ref('ins_auto_pop_wt_new_premiums_full_inserted') }} ins_auto_master_table_2022
                          WHERE  (ins_auto_master_table_2022.age::text = ANY (ARRAY['25'::character varying::text, '40'::character varying::text, '65'::character varying::text])) AND ins_auto_master_table_2022.vehicles::text = '2012 Toyota Camry LE'::text AND (ins_auto_master_table_2022.insurancescore_alignment::text = ANY (ARRAY['Blank'::character varying::text, 'Good'::character varying::text])) AND ins_auto_master_table_2022.driving_record_violations::text = 'Clean'::text and is_user_a_veteran ='No'   AND ins_auto_master_table_2022.bi_pd_limit = 'State Minimum'::text
                          GROUP BY data_date, ins_auto_master_table_2022.age, ins_auto_master_table_2022.national_presence, ins_auto_master_table_2022.national_provider, 'State Min - 1500 comp_coll'::text) t2 
                          On t2.data_date = t.data_date and t.age::text = t2.age::text AND t.national_provider::text = t2.national_provider::text AND t.coverage = t2.coverage AND t.national_presence = t2.national_presence
                UNION
                 SELECT t.data_date,
                    t.age,
                   ...
                   FROM ( SELECT  data_date,
                     ...
                     LEFT JOIN ( SELECT  data_date,
                           ...
                           FROM {{ ref('ins_auto_pop_wt_new_premiums_full_inserted') }} ins_auto_master_table_2022
                          WHERE  (ins_auto_master_table_2022.age::text = ANY (ARRAY['25'::character varying::text, '40'::character varying::text, '65'::character varying::text])) AND ins_auto_master_table_2022.vehicles::text = '2012 Toyota Camry LE'::text AND (ins_auto_master_table_2022.insurancescore_alignment::text = ANY (ARRAY['Blank'::character varying::text, 'Good'::character varying::text])) AND ins_auto_master_table_2022.driving_record_violations::text = 'Clean'::text and is_user_a_veteran ='No'   AND ins_auto_master_table_2022.bi_pd_limit = 'State Minimum'::text
                          GROUP BY data_date, ins_auto_master_table_2022.age, ins_auto_master_table_2022.national_presence, ins_auto_master_table_2022.national_provider, 'State Min - 1000 comp_coll'::text) t2 
                          ON t.data_date = t2.data_date AND t.age::text = t2.age::text AND t.national_provider::text = t2.national_provider::text AND t.coverage = t2.coverage AND t.national_presence = t2.national_presence
                UNION
                 SELECT t.data_date,
                    t.age,
                   ...
                   FROM ( SELECT  data_date,
                     ...
                     LEFT JOIN ( SELECT  data_date,
                          ...
                          GROUP BY data_date, ins_auto_master_table_2022.age, ins_auto_master_table_2022.national_presence, ins_auto_master_table_2022.national_provider, '300/500/300,000 - 500 comp_coll'::text) t2 
                          On t2.data_date = t.data_date and t.age::text = t2.age::text AND t.national_provider::text = t2.national_provider::text AND t.coverage = t2.coverage AND t.national_presence = t2.national_presence
                UNION
                 SELECT t.data_date,
                    t.age,
                   ...
                   FROM ( SELECT  data_date,
                     ...
                     LEFT JOIN ( SELECT  data_date,
                           ...
                           FROM {{ ref('ins_auto_pop_wt_new_premiums_full_inserted') }} ins_auto_master_table_2022
                          WHERE  (ins_auto_master_table_2022.age::text = ANY (ARRAY['25'::character varying::text, '40'::character varying::text, '65'::character varying::text])) AND ins_auto_master_table_2022.vehicles::text = '2012 Toyota Camry LE'::text AND (ins_auto_master_table_2022.insurancescore_alignment::text = ANY (ARRAY['Blank'::character varying::text, 'Good'::character varying::text])) AND ins_auto_master_table_2022.driving_record_violations::text = 'Clean'::text and is_user_a_veteran ='No'   AND ins_auto_master_table_2022.bi_pd_limit = '300/500/300000'::text
                          GROUP BY data_date, ins_auto_master_table_2022.age, ins_auto_master_table_2022.national_presence, ins_auto_master_table_2022.national_provider, '300/500/300,000 - 1000 comp_coll'::text) t2 
                          On t2.data_date = t.data_date and t.age::text = t2.age::text AND t.national_provider::text = t2.national_provider::text AND t.coverage = t2.coverage AND t.national_presence = t2.national_presence
                UNION
                 SELECT t.data_date,
                    t.age,
                   ...
                   FROM ( SELECT  data_date,
                     ...
                     LEFT JOIN ( SELECT  data_date,
                           ...
                           FROM {{ ref('ins_auto_pop_wt_new_premiums_full_inserted') }} ins_auto_master_table_2022
                          WHERE  (ins_auto_master_table_2022.age::text = ANY (ARRAY['25'::character varying::text, '40'::character varying::text, '65'::character varying::text])) AND ins_auto_master_table_2022.vehicles::text = '2012 Toyota Camry LE'::text AND (ins_auto_master_table_2022.insurancescore_alignment::text = ANY (ARRAY['Blank'::character varying::text, 'Good'::character varying::text])) AND ins_auto_master_table_2022.driving_record_violations::text = 'Clean'::text and is_user_a_veteran ='No'   AND ins_auto_master_table_2022.bi_pd_limit = '300/500/300000'::text
                          GROUP BY data_date, ins_auto_master_table_2022.age, ins_auto_master_table_2022.national_presence, ins_auto_master_table_2022.national_provider, '300/500/300,000 - 1500 comp_coll'::text) t2 
                          On t2.data_date = t.data_date and t.age::text = t2.age::text AND t.national_provider::text = t2.national_provider::text AND t.coverage = t2.coverage AND t.national_presence = t2.national_presence
                UNION
                 SELECT t.data_date,
                    t.age,
             ...
             UNION
                 ...
                 SELECT 
                    ...
                    cte_2.age,
                    cte_2.coverage,
                    cte_2.national_presence,
                    min(cte_2.annual_premium) AS min_premium,
                    max(cte_2.annual_premium) AS max_premium
                    FROM cte_2
                    GROUP BY cte_2.data_date, cte_2.age, cte_2.coverage, cte_2.national_presence
                 ...
                 SELECT a.data_date,
                   ...
                   FROM cte_2 a
                     LEFT JOIN cte_min m ON a.data_date = m.data_date AND a.age::text = m.age::text AND a.coverage = m.coverage and a.national_presence = m.national_presence
                ),cte_scores as (
					select age,coverage,national_presence,data_date,
					...
					from cte_3
					group by age,coverage,national_presence,data_date
				), cte_score AS (
                 SELECT a.data_date,
                    a.national_presence,
                    a.age,
					...
					on cte_scores.age = a.age and cte_scores.coverage = a.coverage and cte_scores.national_presence = a.national_presence and cte_scores.data_date = a.data_date
                ), cte_best AS (
                 SELECT a.data_date,
                    a.national_presence,
                    a.age,
                    ...
                    dense_rank() OVER (PARTITION BY a.data_date, a.age, a.coverage, a.national_presence ORDER BY (stability_score +  satisfaction_score + claims_score +coverage_score + affordability_score)DESC NULLS LAST)::varchar AS rank_state_best,
            		...
            		ELSE 
                    dense_rank() OVER (PARTITION BY a.data_date, a.age, a.coverage, a.national_presence ORDER BY (stability_score +  satisfaction_score + claims_score +coverage_score + affordability_score) DESC NULLS LAST)::varchar
