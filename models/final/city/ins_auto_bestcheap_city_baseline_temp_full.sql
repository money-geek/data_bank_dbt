   ...
   FROM ( WITH cte_1 AS (
                 SELECT t.data_date,
                   ...
                   FROM ( SELECT data_date,
                          ...
                          WHERE ins_auto_master_table_city_2022.age in ('25','40','65')
                          AND ins_auto_master_table_city_2022.comp_coll_deductible = '1000/1000'::text 
                          AND ins_auto_master_table_city_2022.bi_pd_limit = '100/300/100000'::text 
                          AND ins_auto_master_table_city_2022.is_user_a_veteran = 'No'::text
                ...
                UNION
                 SELECT t.data_date,
                   ...
                   FROM ( SELECT data_date,
                           ...
                           FROM {{ ref('ins_auto_monthly_new_premiums_city_full_inserted') }} ins_auto_master_table_city_2022
                          WHERE  ins_auto_master_table_city_2022.age  in ('25','40','65')
                          AND ins_auto_master_table_city_2022.bi_pd_limit = 'State Minimum'::text 
                            AND ins_auto_master_table_city_2022.is_user_a_veteran = 'No'::text
                          GROUP BY data_date,vehicles,insurancescore_alignment,is_user_a_veteran,driving_record_violations, age, state, city, provider,provider_id, 'Minimum Coverage'::text ) t
                ), cte_2 AS (
