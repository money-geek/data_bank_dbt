	--drop table if exists home_temp_credit_credit_tier;
	--create table home_temp_credit_credit_tier as
	...
	,one_exc as (
		SELECT
		b.state,'Excellent' as credit_tier,b.coverages,b.construction_year,
	...
	,one_fair as (
		SELECT
		b.state,'Fair' as credit_tier,b.coverages,b.construction_year,
		b.cov_a_dwelling,b.provider,b.place_tier,b.place_tier_rank,b.claims_history,
		b.protection_class,b.construction_type,b.roof_type,b.all_perils_deductible,
	...
	,one_bellow as (
		SELECT
		b.state,'Below Fair' as credit_tier,b.coverages,b.construction_year,
		b.cov_a_dwelling,b.provider,b.place_tier,b.place_tier_rank,b.claims_history,
		b.protection_class,b.construction_type,b.roof_type,b.all_perils_deductible,
	...
	,one_poor as (
		SELECT
		b.state,'Poor' as credit_tier,b.coverages,b.construction_year,
		b.cov_a_dwelling,b.provider,b.place_tier,b.place_tier_rank,b.claims_history,
		b.protection_class,b.construction_type,b.roof_type,b.all_perils_deductible,
